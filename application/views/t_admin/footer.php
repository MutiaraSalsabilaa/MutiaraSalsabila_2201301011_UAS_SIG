...
<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"
    ...
    foreach ($data as $row) {
        ...
        echo "var marker = L.marker([" . $row->lat . ", " . $row->lng . "], {icon: iconApotek}).addTo(map).bindPopup('<b>" . $row->nama_dinas . "</b><br><img src=\"../file/" . $row->foto . "\" alt=\"Foto\" style=\"width: 100px; height: auto;\"><br>" . $row->alamat . "');";
    }
    ?>
